...
learnsmart_default_num_drops=1
...
def calc_assignment_average(name_pair, student_scores, num_drops, max_points, worksheet=False):
    ...
    total_score=sum(new_student_scores)
...
for i in range(1,len(grades_list_of_dicts)):
    ...
    worksheet_avg=calc_assignment_average(name_pair, worksheet_grades_list, worksheet_default_num_drops, worksheet_max_score, True)
